<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if (Auth::user()->hasRole('Vrijwilliger'))
                            <x-nav-link href="{{ route('voedselpakketten.gezinnen.index') }}" :active="request()->is('voedselpakketten*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if (Auth::user()->hasRole('Vrijwilliger'))
                    <x-responsive-nav-link href="{{ route('voedselpakketten.gezinnen.index') }}" :active="request()->is('voedselpakketten*')">
                        Overzicht voedselpakketten
                    </x-responsive-nav-link>
                @endif
            @endauth
